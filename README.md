...
<p align="justify">Download pretrained adversarial generators from  [ImageNet](http://www.image-net.org/) [here](https://drive.google.com/open?id=1H_o90xtHYbK7M3bMMm_RtwTtCdDmaPJY) to 'saved_models' folder.<p >
